...
\cite{caruso-roe-vaccon:14a} and fill in certain details. % Add usual way to track precision.
...
reflected by the equality sign in Eq.~\eqref{eq:firstorder}. % define coordinate-wise and lattice-wise here.
...
to manifolds over $K$ and covers in this way a very large family of
...
\end{deftn} % Add explanation here - smallest lattice containing H here.
...
$f^{-1}(W)$. As before, this map does not take its values in a single 
