...
\begin{abstract}
Based on the framework of ``differential precision'' developed in a
previous work by the same authors, we study 
the $p$-adic stability of standard operations on matrices and vector 
spaces. In particular, we highlight that lattice-based methods can be
quite profitable in many cases (\emph{e.g.} matrix multiplication). We 
underpin this observation by numerous numerical evidences.
\end{abstract}
