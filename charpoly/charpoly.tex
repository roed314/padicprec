...
\todo{Rewrite this subsection with more details.}
...
\xavier{I propose to move Proposition \ref{prop:mainlem} here.}
...
which is, at first sight, in $O(n^4)$\tristan{Shouldn't it be $\softO (n^4)$?} operations in $K.$
\end{rem}
