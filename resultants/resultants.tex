...
\usepackage[norelsize,algoruled,vlined,english,linesnumbered]{algorithm2e}
...
\urladdr{http://perso.univ-rennes1.fr/xavier.caruso}

\subjclass{11S99, 11Y99, 68W30}

\keywords{Euclide algorithm, ultrametric precision, subresultants}
...
\noindent
\textit{Tracking precision globally.}
%
...
\begin{algorithm}
  ...
  \For{$j = (d-1), (d-2), \ldots, 1$}
    {$r_j \leftarrow$ coefficient in $X^j$ of $R_j$
     ...
     \lIf{$\val(r_j) \geq \frac N 2$}{\textbf{raise} NotImplementedError}
