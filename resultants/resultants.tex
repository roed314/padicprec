...
polynomials of fixed degree. \todo{(Donner l'algorithme.)} Looking at the last line, we see that 
...
& \text{for } i \geq -1. 
\end{array}\right.$$
Here $n_i = \deg S_i$ \todo{define $\delta_i$ and change the notation} 
