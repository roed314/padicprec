...
#sage: g1
#[x^3, x*y + (2251799813685218 + O(2^51))*x^2, y^2 + (1125899906842617 + O(2^50))*x^2, z + (2 + O(2^51))*x]
#sage: g2
#[x^3, x*y + (1125899906842594 + O(2^50))*x^2, y^2 + (281474976710649 + O(2^48))*x^2, z + (2 + O(2^51))*x]