...
\conferenceinfo{ISSAC'16,}{July 19--22, 2016, Waterloo, ON, Canada} \isbn{978-1-4503-4380-0/16/07}
\acmPrice{\$15.00}
\doi{http://dx.doi.org/10.1145/2930889.2930897}
...
\citelist{\cite{pauli:10a} \cite{guardia-nart-pauli:12a} \cite{guardia-montes-nart:08a} \cite{montes:99a}}
...
%\todo{Is this sufficiently precision complexity analysis?}
...
%\todo{(there is a sign error here)}. (Tristan:fixed)
...
%\end{array}
\end{equation}
We notice that, when the polynomial $P$ is changed into $cP$ where $c$ is a 
...
$\NF(P)(d) = d \lambda_0$, \emph{i.e.} $\varphi(x) = \lambda_0 x$ for $x > d$.
...
Therefore $b_0(T_0) \geq \kappa$ results from $b_\varphi(A_0{-}P) \geq 
...
coefficient is \emph{exactly}~$1$; the precision datum of $P$ then 
...
\noindent {\bf Algorithm} {\tt slope\_factorisation\_Newton}

\noindent{\bf Input:} a monic polynomial $P + O(\varphi_P) \in K_n[X]$,

\noindent\phantom{{\bf Input:} }a break point $d$ of $\NP(P)$

\noindent{\bf Output:} the factor $A$ described above
...
\smallskip\noindent 6.\ \hspace{5mm}%
lift $A_i$, $V_i$ and $P$ at enough precision

\smallskip\noindent 7.\ \hspace{5mm}%
compute 
...
raised above: the precision of the couple $A^{(1)}$ is the lattice 
...
\bib{berthomieu-hoeven-lecerf:11a}{article}{
      author={Berthomieu, J{\'e}r{\'e}my},
...
\bib{caruso:16}{unpublished}{
      author={Caruso, Xavier},
       title={Slope factorization of ore polynomials},
        date={2016},
        note={in preparation},
}

\bib{caruso-roe-vaccon:14a}{article}{
      author={Caruso, Xavier},
...
\bib{caruso-roe-vaccon:15a}{inproceedings}{
      author={Caruso, Xavier},
      author={Vaccon, Tristan},
      author={Roe, David},
       title={$p$-adic stability in linear algebra},
        date={2015},
   booktitle={Proceedings of the 2015 acm on international symposium on
...
\bib{dwork-geratto-sullivan:Gfunctions}{book}{
      author={Dwork, Bernard},
      author={Gerotto, Giovanni},
...
\bib{guardia-montes-nart:08a}{article}{
      author={Gu\`ardia, Jordi},
      author={Montes, Jes\'us},
      author={Nart, Enric},
...
\bib{guardia-nart-pauli:12a}{article}{
      author={Guàrdia, Jordi},
      author={Nart, Enric},
      author={Pauli, Sebastian},
       title={Single-factor lifting and factorization of polynomials over local
  fields},
        date={2012},
...
\bib{montes:99a}{thesis}{
      author={Montes, Jes\'us},
       title={Pol\'igonos de newton de orden superior y aplicaciones
  aritm\'eticas},
        type={Ph.D. Thesis},
        date={1999},
}

\bib{pauli:10a}{inproceedings}{
      author={Pauli, Sebastian},
   ...
   booktitle={Algorithmic number theory, 9th international symposium},
      ...
      editor={Morain, Fran{\c c}ois},
      editor={Thom\'e, Emmanuel},
     address={Nancy, France},
}

\bib{hoeven:02a}{article}{
      author={van~der Hoeven, Joris},
...
\bib{poteaux-rybowicz}{inproceedings}{
  author    = {Poteaux, Adrien},
  author    = {Rybowicz, Marc},
