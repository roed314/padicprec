...
for computing these factorizations: indeed the algorithm we obtain has 
a quasi-optimal complexity (compared to the size of the input 
polynomial) and outputs a result whose precision is (close to be) 
optimal. One important feature of our algorithm is its simplicity 
and its flexibility: in particular, unlike standard previous slope 
factorization algorithms, it does not require working with
