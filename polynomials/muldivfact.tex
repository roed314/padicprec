...
$P$ (resp. to the constant coefficient of $P$) and theorem is clear. \todo{Should this be $d=0$? (Tristan:) I agree, I have tried to change accordingly the previous and following statement.}
We then assume $1 \leq d < n$. Without loss of generality, we may further 
