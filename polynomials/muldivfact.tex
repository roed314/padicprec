...
\geq \kappa$. We illustrate this fact with the following picture. 


\begin{tikzpicture}
[xscale=0.7, yscale=0.5]
...
\node[scale=0.9, below right] at (2.5,.6) { $\mathbf{A_0}$ };
\node[scale=0.9, right] at (10.2,7.3) { $P$ };
%\node[scale=0.9, right] at (10.5,4.4) { $\Delta$ };
\node[scale=0.9] at (4.2,1.2) { $\kappa$ };
\node[thick] at (3,9) { $R_0$ };
\node[thick] at (3,8.5) { $S_0$ };
\node at (6.8,2.3) { $\lambda_1$ };
\node at (6.8,.9) { $\lambda_0$ };
