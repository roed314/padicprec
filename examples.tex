...
k_1 + \cdots + k_\ell$, it is defined by:
$$\binom s {k_1 \,\, k_2 \,\, \cdots \,\, k_\ell} =
  \frac{s!}{k_1!\: k_2! \cdots k_\ell! \: (s{-}k_1{-}\cdots{-}k_\ell)!}.$$
We recall that they are always positive integers.
...
proposition which can be used directly in combination with Proposition
3.12 of \cite{padicprec}.
...
can certainly choose $\Lambda_h = \Lambda(h)$.
...
With this choice, the norms of $f(x)$ and $h(x)$ are comparable --- 
...
maximum of those of $f(x)$ and $h(x)$ respectively.
