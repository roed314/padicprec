...
A function $f \col U \rightarrow F$ is said to be \emph{locally analytic} if for any $x \in U,$ there exists some open subset $U_x$ of $E$ and some $n$-linear mappings $L_n \: : \: E^n \rightarrow F$ for any $n \geq 1,$ such that : for any $y \in U_x,$ the sum $\sum_{n \geq 1} L_n(y,\dots,y)$ converges in F, and $f(x+y)=f(x)+\sum_{n \geq 1} L_n(y,\dots,y).$
\end{deftn}
