...
\todo{sum, product, inverse, $p$-power map}

\subsubsection{Polynomials}

\todo{
Euclidean division, factorization, Grobner basis (?)
}

\subsubsection{Matrices}

\todo{
determinant, characteristic polynomial, LU factorization, QR 
factorization, kernels, images}

\subsubsection{Sub vector spaces}

\todo{intersection, sum}
