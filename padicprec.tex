...
$\varepsilon C < 1$. Let $U_\varepsilon \subset E$ be given by definition \ref{deftn : diff} and the fact 
...
surjectivity of $f'(0)$, there exists $x_1 \in E$ such that $f'(0) \cdot 
