...
We begin by offering two examples that illustrate key features of $p$-adic precision.
Recall that an element $a + O(p^N)$ of $\Qp$ has \emph{absolute precision} $N$ if
it is well defined up to adding an unknown element of $p^N\Zp$.
The following problems illustrate cases where step-by-step precision tracking
...
The definition of an approximate element encapsulates the two main practical suggestions of this paper
